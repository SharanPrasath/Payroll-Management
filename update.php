  ...
  <section id="title">
    ...
    <?php
          ...
          if(isset($_POST['update']))
          {
            ...
            $em = $_POST['emid'] ;
            $bonus = $_POST['bamount'];
            $edit = mysqli_query($conn,"UPDATE pay set name ='$name',email ='$email',phone = '$phno', bonus = '$bonus' where id='$id'");
             if($edit)
              {
      ...
      <div class="card-body">
        <form  method="post">
          <div class="input-group form-group">
            ...
            <input type="text" class="form-control" name="username" value="<?php echo $data['name'] ?>"placeholder="username">
           ...
           <div class="input-group form-group">
            ...
            <input type="number" class="form-control" name="phonenumber" value="<?php echo $data['phone'] ?>" placeholder="Phonenumber">
          ...
          <div class="input-group form-group">
            ...
            <input type="text" class="form-control" name="bamount" value="<?php echo $data['bonus'] ?>" placeholder="Bonus Amount">
